...
>(({ className, ...props }, ref) => (
	<AlertDialogPortal>
		...
		<AlertDialogPrimitive.Content
			ref={ref}
			className={cn(
				"bg-background fixed top-1/2 left-1/2 z-1000 grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 border p-6 shadow-lg",
				"data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 duration-200",
